...
<div class="board_view_area" v-for="(user, idx) in boardData" :key="idx">
          ...
          <div class="board_number">
            ...
            <input type="text" v-model= "bId" ref="bId" class="form-control" placeholder="제목" aria-label="Username" aria-describedby="basic-addon1">
          </div>
        ...
        <button type="button" id="modify" class="btn btn-primary"><a :href="'/modify_view?bId=' + user.bId" >수정</a></button>
...
export default {
	...
	,methods:{
       //게시물 상세 내용 보기 
		fnGetView() {
            var bId = this.bId;
			axios.get('http://192.168.200.148:8082/mymy/Board_view',{
            params: {
                bId : bId
            }
        })
		...
		,doDelete(){
            ...
            if(!Q1){
                ...
                alert("게시물을 삭제합니다.");
                 axios.get('http://192.168.200.148:8082/mymy/delete',{
                    params: {
                    bId : bId
            }
        })
